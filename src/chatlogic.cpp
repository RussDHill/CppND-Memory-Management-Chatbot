            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        auto newNode = std::find_if(_nodes.begin(), _nodes.end(), [&id](std::shared_ptr<GraphNode> const& node) { return node->GetID() == id; });
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            { 
                                // int i = node->GetID();
                                // int j = std::stoi(parentToken->second); 
                                // return true;
                            ...
                            { 
                                // int i = node->GetID();
                                // int j = std::stoi(childToken->second); 
                                // return true;
